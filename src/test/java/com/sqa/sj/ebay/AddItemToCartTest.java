...
public class AddItemToCartTest extends EbayTest {
	 ...
	 * @param baseUrl
	 */
	public AddItemToCartTest(String baseUrl) {
		super(baseUrl);
	...
	public Object[][] csvData() {
		return DataHelper.getTextFileData("src/main/resources/", "ebayitem.csv", TextFormat.CSV, false,
				new DataType[] { DataType.INT, DataType.STRING, DataType.INT, DataType.DOUBLE });
	}

	@DataProvider(name = "dbData")
	public Object[][] databaseData() throws ClassNotFoundException, DataTypesMismatchException, SQLException,
	...
	public Object[][] dp() {
		return new Object[][] {
				new Object[] { "BenQ HT2050 3D DLP Full HD 1080P Home Theater Gaming Projector HDMI 2200 Lumens", 3,
						2099.97 },
				new Object[] { "Android 4.4 Quad Core 16GB HD WIFI Tablet PC Case Cover For Kids", 4, 235.96 },
				new Object[] { "SAFETY GLASSES CLEAR LENS SPORT WORK EYEWEAR PYRAMEX ZTEK S2510S 12 PAIR Z87.1", 5,
						79.45 },
				new Object[] { "72 pc Army Men Toy Soldiers Military Gray Green Plastic Figurine Action Figure", 6,
						41.94 },
				new Object[] { "Colorful Food Hot Dog Pizza Taco For Apple iPhone 6 6S 4.7 Case Cover Screen", 4,
						59.80 },
	...
	public void testAddItemToCartTest(int id, String itemToAdd, int quantity, double expectedCost) {
		getLog().info("Test-" + id + ": Add item to cart: " + itemToAdd + " [" + quantity
				+ "] for an expected price of $" + expectedCost);
