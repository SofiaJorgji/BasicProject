...
public class TC14 extends AdactinTest {
	...
	public void ap14() {
		...
		bookNowButton.click();
		String expectedOrderId = "1KA5AMC9Z6";
		String actualOrderId =
				getDriver().findElement(By.id("order_no")).getAttribute("value");
		System.out.println(actualOrderId);
		if (actualOrderId != null && !actualOrderId.trim().isEmpty()) {
			System.out.println("Order number is not empty");
		}
	}
}
